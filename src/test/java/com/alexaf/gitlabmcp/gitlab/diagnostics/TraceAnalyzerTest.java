...
class TraceAnalyzerTest {
    ...
    private static Job job(String failureReason) {
        return new Job(8L, "test", "test", "failed", failureReason, "https://gitlab.example/jobs/8",
                "main", false, false, null, null, null, 1.0, 0.1, List.of());
    }
    ...
    void analyzeDetectsAuthenticationFailure() {
        ...
        assertThat(analysis.nextSteps()).containsExactly("Verify credentials, token scopes, and project or registry permissions.");
    }
