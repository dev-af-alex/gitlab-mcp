...
class GitlabContractFixtureTest {
    ...
    void decodesSanitizedContractsAcrossSupportedGitlabMajors(
            String fixture, boolean mergeRequestDiffs, boolean artifactTree) throws Exception {
        try (InputStream input = getClass().getResourceAsStream("/gitlab-contract/" + fixture)) {
            ...
            var version =
                    objectMapper.treeToValue(root.path("version"), GitlabServerInfoProvider.VersionResponse.class);
            ...
            GitlabTestReport report = objectMapper.treeToValue(root.path("test_report"), GitlabTestReport.class);
