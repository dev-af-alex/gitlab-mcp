...
class GenericTraceFailureAnalyzerTest {
    ...
    private final GenericTraceFailureAnalyzer analyzer =
            new GenericTraceFailureAnalyzer(new TraceAnalyzer());
    ...
    private PipelineContext context(Map<Long, String> traces) {
        ...
        Job job = new Job(7L, "pytest", "test", "failed", "script_failure", null,
