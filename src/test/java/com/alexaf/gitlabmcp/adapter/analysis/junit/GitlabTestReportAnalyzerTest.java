...
class GitlabTestReportAnalyzerTest {
    ...
    void analyzesPytestFailureFromLanguageIndependentGitlabReport() {
        ...
        GitlabTestSuite suite = new GitlabTestSuite("pytest", 1.0, 2, 1, 1, 0, 0, List.of(testCase));
        GitlabTestReport report = new GitlabTestReport(1.0, 2, 1, 1, 0, 0, List.of(suite));
        PipelineContext context = new PipelineContext(pipeline(), List.of(), report, false, 0);
        ...
        assertThat(findings).singleElement().satisfies(finding -> {
            ...
            assertThat(finding.summary()).contains("tests.test_checkout#test_checkout", "failed");
    ...
    private Pipeline pipeline() {
        return new Pipeline(42L, 1L, 1L, "sha", "main", "failed", "push", null, null, null, null, 1L, 1L, null);
    }
}
